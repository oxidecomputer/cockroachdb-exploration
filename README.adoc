...
* Maybe some even more basic testing
** behavior using haproxy as a load balancer when queries just take a while
** can we reproduce the basic sysbench results on their website?
** can we reproduce any other benchmarking results on their website?
** can we run one of those for an extended period?
* Basic testing
