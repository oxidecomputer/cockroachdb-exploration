...
* Review README to see what other experiments are worth doing before writing upr esults
...
TODO today:
- finish updating section above on contracting cluster (look for "23:47Z" above)
- grab graphs from CockroachDB of throughput, replica count during this whole period and get those graphs into this repo
