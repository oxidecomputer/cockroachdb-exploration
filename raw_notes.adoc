...
* take zfs snapshots, EBS snapshots? so that we can roll back to this state
* run an extended read-write workload to settle into a new steady state (make any splits/merges happen)
* run expansion / contraction experiments with new database
